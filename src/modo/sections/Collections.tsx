  ...
  return (
    ...
    >
      ...
      <div ref={headerRef} className="max-w-7xl mx-auto pt-32 pb-8 px-8 lg:px-16">
        <p className="reveal-header museo-label text-[#92700E] mb-4">
      ...
      <div ref={stackRef} className="relative">
        {collectionsConfig.collections.map((item, index) => (
          <div
            ...
            className="relative w-full min-h-screen bg-[#F7F3EA] will-change-transform"
          ...
          >
            <div className="max-w-7xl mx-auto px-8 lg:px-16 py-16 lg:py-24 flex items-center min-h-screen">
              ...
              >
                ...
                >
                  <p className="coll-text-el museo-label text-[#92700E] mb-3">
                    {item.year}
                  </p>
                  ...
                  {collectionsConfig.ctaText && (
                    <Link
                      to={collectionsConfig.ctaHref}
                      data-cursor="hover"
                      className="coll-text-el inline-flex items-center gap-2 museo-label text-[#1a1a1a] border border-[#1a1a1a]/20 px-6 py-3 hover:bg-[#D4AF37] hover:text-[#1a1a1a] hover:border-[#D4AF37] transition-all duration-300"
                    >
                      {collectionsConfig.ctaText}
