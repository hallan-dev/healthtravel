import { ArrowUpRight, Instagram, Twitter, Facebook, Linkedin, Youtube, Globe, Music2 } from 'lucide-react';
...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full bg-[#0E1A2B] overflow-hidden">
      {/* Marquee Section */}
        ...
        <div className="max-w-7xl mx-auto">
                ...
                {footerConfig.socialLinks.map((link, i) => {
                  ...
                  return (
                    <a
                      ...
                      rel="noreferrer"
                      data-cursor="hover"
                      className="w-10 h-10 border border-white/20 flex items-center justify-center text-white/60 hover:text-[#D4AF37] hover:border-[#D4AF37]/60 transition-colors"
                    >
                  ...
                  {footerConfig.quickLinks.map((link, i) => (
                    <li key={i}>
                      <Link
                        to={link.href}
                        data-cursor="hover"
                        className="group museo-body text-white/70 text-sm hover:text-[#D4AF37] transition-colors flex items-center gap-2"
                      >
                        {link.label}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-white/10">
            <p className="museo-body text-white/40 text-xs mb-4 md:mb-0">
              © {currentYear} {footerConfig.brandName} — Tous droits réservés.
            </p>
